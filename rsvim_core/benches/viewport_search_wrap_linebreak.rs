...
fn bench_search_wrap_linebreak(c: &mut Criterion) {
  ...
  let mut g = c.benchmark_group("bench_search_wrap_linebreak");
...
criterion_group!(benches, bench_search_wrap_linebreak);
