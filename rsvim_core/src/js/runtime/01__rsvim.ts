...
export interface RsvimCmd {
   ...
   * @param {RsvimCmd.CommandOptions} options - Options that control how a command is created, such as `force`, etc. This parameter can be omitted, it will use the default options, see {@link RsvimCmd.CommandOptions}.
