...
impl NormalStateful {
  ...
  // Returns new `line_idx` and `char_idx` for cursor position.
  //
  // NOTE: `x` is char index, `y` is line index.
  fn _cursor_move_to(
    &self,
    viewport: &Viewport,
...
#[cfg(test)]
#[allow(unused_imports)]
mod tests_cursor_move_vertically_by {
...
#[cfg(test)]
#[allow(unused_imports)]
mod tests_cursor_move_horizontally_by {
  use super::tests_util::*;
  use super::*;
...
mod tests_cursor_move_to {
  ...
  fn nowrap4() {
...

    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful = stateful_machine.cursor_move(&data_access, Command::CursorMoveTo((0, 1)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));

      let tree = data_access.tree.clone();
      let actual = get_cursor_viewport(tree);
      assert_eq!(actual.line_idx(), 1);
      assert_eq!(actual.char_idx(), 0);
    }
  ...
  fn wrap1() {
    ...
    let data_access = StatefulDataAccess::new(state, tree, bufs, Event::Key(key_event));
    let stateful = NormalStateful::default();
    let next_stateful = stateful.cursor_move(&data_access, Command::CursorMoveTo((7, 2)));
    assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
    ...
    let next_stateful = stateful.cursor_move(&data_access, Command::CursorMoveTo((0, 1)));
    assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
  ...
  fn wrap2() {
    ...
    let data_access = StatefulDataAccess::new(state, tree, bufs, Event::Key(key_event));
    let stateful = NormalStateful::default();
    let next_stateful = stateful.cursor_move(&data_access, Command::CursorMoveTo((2, 2)));
    assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
...
#[cfg(test)]
#[allow(unused_imports)]
mod tests_window_scroll_vertically_by {
  use super::tests_util::*;
  use super::*;
...
#[cfg(test)]
#[allow(unused_imports)]
mod tests_window_scroll_horizontally_by {
  use super::tests_util::*;
  use super::*;
...
mod tests_window_scroll_to {
  ...
  fn wrap2() {
    ...
    // Scroll-2
    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful =
        stateful_machine._window_scroll(&data_access, Command::WindowScrollTo((0, 9)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
    ...
    // Scroll-3
    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful =
        stateful_machine._window_scroll(&data_access, Command::WindowScrollTo((0, 12)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
  ...
  fn wrap4() {
    ...
    // Scroll-2
    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful =
        stateful_machine._window_scroll(&data_access, Command::WindowScrollTo((9, 0)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
    ...
    // Scroll-3
    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful =
        stateful_machine._window_scroll(&data_access, Command::WindowScrollTo((12, 0)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
    ...
    // Scroll-4
    {
      ...
      let stateful_machine = NormalStateful::default();
      let next_stateful =
        stateful_machine._window_scroll(&data_access, Command::WindowScrollTo((11, 0)));
      assert!(matches!(next_stateful, StatefulValue::NormalMode(_)));
