...
mod tests {
  ...
  fn cast_geo_points() {
    ...
    let actual1 = mc_geo_point_as!(p1, usize);
    ...
    let actual2 = mc_geo_point_as!(p2, i32);
    ...
    let actual3 = mc_geo_point_as!(p3, i16);
  ...
  fn cast_geo_rects() {
    ...
    let actual1 = mc_geo_rect_as!(r1, u8);
    ...
    let actual2 = mc_geo_rect_as!(r2, i32);
    ...
    let actual3 = mc_geo_rect_as!(r3, i16);
  ...
  fn cast_geo_sizes() {
    ...
    let actual1 = mc_geo_size_as!(s1, u8);
    ...
    let actual2 = mc_geo_size_as!(s2, i32);
    ...
    let actual3 = mc_geo_size_as!(s3, i16);
