...
mod tests_undo {
  ...
  fn delete2() {
    ...
    undo.current_mut().delete(Delete {
      ...
      delete_start_char_idx: 11,
      new_char_idx: 10,
    });
    undo.current_mut().delete(Delete {
      payload: "l".to_compact_string(),
      delete_start_char_idx: 10,
      new_char_idx: 9,
    });
