...
mod tests_search_anchor_horizontally_wrap_linebreak {
  ...
  fn new3() {
    ...
    let buf = make_buffer_from_lines(
      ...
      buf_opts,
      vec![
        "Hello, RSVIM! This is a super longwordthatdonthaveanywhitespacestobreakitintomultiplepieces, we will have to fallback to 'linebreak=false' behavior to tolenrant it.\n",
      ],
    );
