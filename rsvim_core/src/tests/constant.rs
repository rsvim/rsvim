...
pub struct TempPathCfg {
  ...
  saved_home_dir: Result<String, VarError>,
  saved_xdg_config_home: Result<String, VarError>,
  saved_xdg_cache_home: Result<String, VarError>,
  saved_xdg_data_home: Result<String, VarError>,
...
impl TempPathCfg {
  ...
  pub fn restore(&self) {
    ...
    restore_env_var(HOME, self.saved_home_dir);
    restore_env_var(XDG_CONFIG_HOME, self.saved_xdg_config_home);
    restore_env_var(XDG_CACHE_HOME, self.saved_xdg_cache_home);
    restore_env_var(XDG_DATA_HOME, self.saved_xdg_data_home);
  }
}
