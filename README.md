...
- To provide a powerfull TUI engine similar to GUI frameworks such as [Qt](https://www.qt.io/) and [Tk](https://tkdocs.com/).
...
- To be a headless text processing tool, allows scripting to batch process text contents.
