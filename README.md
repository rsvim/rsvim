...
<p>
  ...
  <a href="https://github.com/rsvim/rsvim/actions/workflows/ts.yml"><img alt="ts_lint.yml" src="https://img.shields.io/github/actions/workflow/status/rsvim/rsvim/ts_lint.yml?branch=main&label=ts" /></a>
