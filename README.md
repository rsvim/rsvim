...
- Thanks to [@deno](https://github.com/denoland) team for the **[rusty_v8](https://github.com/denoland/rusty_v8)** and **[deno](https://github.com/denoland/deno)** project. An extremely way to easily embed the v8 js engine instead of compiling from source code with `gn` is provided by the **rusty_v8** project. RSVIM also follows most of deno's runtime APIs design, as they are very user friendly and ergonomic.
