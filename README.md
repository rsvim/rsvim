...
- A powerfull TUI engine similar to GUI framework such as [Qt](https://www.qt.io/) or [Tk](https://tkdocs.com/), supports not only windows, but also popups, dialogs, mouse events, etc.
