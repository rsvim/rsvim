...
RSVIM is an open source terminal text editor, the goal is to be the highly extensible by following the main features and philosophy of ([Neo](https://neovim.io/))[VIM](https://www.vim.org/). While also to be:
