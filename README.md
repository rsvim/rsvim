...
- To be a programmable editor as a VM, provides a consistent scripting runtime environment, with built-in support for async, modern plugin package manager, etc.
