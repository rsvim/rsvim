...
- A powerfull TUI engine, provides complete functions similar to GUI framework like [Qt](https://www.qt.io/) or [Tk](https://tkdocs.com/), support not only windows, but also popups, dialogs, mouse events, etc.
