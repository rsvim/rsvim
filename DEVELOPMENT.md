...
- (Optional) Install Faster Linker:
  - For Linux, install [clang](https://llvm.org/), [mold](https://github.com/rui314/mold)/[wild](https://github.com/davidlattimore/wild) linker and rust components `rustup component add llvm-tools-preview`.
  - For Windows, install [cargo-binutils](https://github.com/rust-embedded/cargo-binutils) and rust components `rustup component add llvm-tools-preview`.
